...
var normalize = require('../tools/normalize.js');
...
var getDerivedStateFromProps = function getDerivedStateFromProps(props, prevState) {
  var _normalize = normalize["default"](props.rows, props.headers, prevState),
  ...
  var state = {
    ...
    rowsById: rowsById,
    cellsById: cellsById,
    sortDirection: prevState.sortDirection || sorting.initialSortState,
  ...
  if (prevState.sortDirection && prevState.sortHeaderKey) {
    var _getSortedState = sorting.getSortedState(props, state, prevState.sortHeaderKey, prevState.sortDirection),
